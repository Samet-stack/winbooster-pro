...
const ALL_TWEAKS = [
  ...
  },
  {
    id: 'disable_vbs',
    category: 'cpu',
    name: 'Core Isolation / VBS Off (+5% à 15% FPS)',
    desc: 'Désactive l\'isolation du noyau (HVCI) pour libérer jusqu\'à 15% de performances CPU brutes en jeu.',
    badge: '+15% FPS BOOST',
    badgeType: 'purple',
    action: () => window.electronAPI.disableVbs(),
    msg: 'VBS / HVCI désactivé (Redémarrage requis pour appliquer)',
    btnLabel: 'Débrider VBS',
    safe: true,
  },
  {
    id: 'enable_fse',
    category: 'esport',
    name: 'Plein Écran Exclusif Forcé (FSE Mode)',
    desc: 'Bypasse la surcouche DWM et les buffers intermédiaires en forçant l\'Exclusive Fullscreen sur tous les jeux.',
    badge: '0 INPUT LAG',
    badgeType: 'emerald',
    action: () => window.electronAPI.enableFse(),
    msg: 'Mode Plein Écran Exclusif forcé',
    btnLabel: 'Forcer FSE',
    safe: true,
  },
  {
    id: 'enable_gpu_tdr',
    category: 'esport',
    name: 'Pipeline GPU & TDR Anti-Freeze',
    desc: 'Augmente la tolérance TdrDelay à 8s et optimise le mode Overlay DXGI pour éliminer les micro-freezes graphiques.',
    badge: 'ANTI-FREEZE',
    badgeType: 'emerald',
    action: () => window.electronAPI.enableGpuTdr(),
    msg: 'Pipeline GPU & TDR optimisés',
    btnLabel: 'Stabiliser GPU',
    safe: true,
  },
  {
    id: 'enable_active_cooling',
    category: 'cpu',
    name: 'System Cooling Policy Active (CPU Turbo Max)',
    desc: 'Force le refroidissement actif avant tout bridage thermique pour maintenir les fréquences Turbo maximales du CPU.',
    badge: '100% SÛR',
    badgeType: 'emerald',
    action: () => window.electronAPI.enableActiveCooling(),
    msg: 'Refroidissement actif et Turbo Max engagés',
    btnLabel: 'Activer Turbo Cool',
    safe: true,
  },
  {
    id: 'disable_qos_p2p',
    category: 'network',
    name: 'Réserve Bande Passante QoS 0% & Anti-P2P',
    desc: 'Récupère les 20% de bande passante réservés par Windows et bloque le partage P2P Delivery Optimization en fond.',
    badge: '100% SÛR',
    badgeType: 'emerald',
    action: () => window.electronAPI.disableQosP2p(),
    msg: 'Réserve QoS 0% et P2P neutralisés',
    btnLabel: 'Libérer 20% Débit',
    safe: true,
  },
  {
    id: 'disable_spectre',
